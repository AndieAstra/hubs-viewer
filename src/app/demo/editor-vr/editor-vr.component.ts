...
@Component({
  ...
  templateUrl: './editor-vr.component.html',
  styleUrl: './editor-vr.component.scss'
})
export class EditorVrComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
