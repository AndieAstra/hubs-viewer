...
import { VrUploaderComponent } from '../vr-uploader/vr-uploader.component';
import { EditorVrComponent } from '../editor-vr.component';

@Component({
  selector: 'app-vr-frame',
  standalone: true,
  imports: [
    FormsModule,
    ApplicationModule,
  ...
  templateUrl: './vr-frame.component.html',
  styleUrl: './vr-frame.component.scss'
})
export class VrFrameComponent implements AfterViewInit {

  constructor(private router: Router) {}

  @ViewChild('viewerCanvas', { static: true }) canvasRef!: ElementRef<HTMLCanvasElement>;
  @ViewChild(EditorVrComponent) viewer!: EditorVrComponent;
